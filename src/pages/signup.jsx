  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50 overflow-hidden items-start justify-center pt-32">
        ...
        <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-emerald-100/40 to-teal-100/40 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }}></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-tr from-cyan-100/30 to-blue-100/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }}></div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-gradient-to-br from-white via-gray-50/30 to-white">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200/50 p-8 hover:shadow-3xl transition-shadow duration-300">
            ...
            {/* Success Alert */}
            {success && (
              <div className="mb-6 p-4 bg-green-50/80 backdrop-blur-sm border border-green-200 rounded-xl flex items-start gap-3 animate-bounce-in">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <Link to="/login" className="text-gray-900 font-semibold hover:underline transition-all hover:text-gray-700">
                  Sign in
                </Link>
              </p>
            </div>
